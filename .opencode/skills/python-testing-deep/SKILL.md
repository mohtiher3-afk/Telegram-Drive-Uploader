---
name: python-testing-deep
description: >
  Complete Python testing system. PROACTIVELY activate for: (1) pytest fundamentals,
  (2) Fixtures and scopes, (3) Parameterized tests, (4) Mocking with pytest-mock,
  (5) Async testing with pytest-asyncio, (6) Coverage configuration, (7) FastAPI testing
  with httpx, (8) Property-based testing with hypothesis, (9) Snapshot testing.
...
auto_load:
  enabled: true
  triggers:
    keywords: [hypothesis, snapshot, property-based, coverage, pytest-cov, pytest-asyncio]
    file_patterns: ["test_*.py", "*_test.py", "conftest.py"]
  priority: medium
  load_with: [python-testing-general, python-fundamentals]
---
