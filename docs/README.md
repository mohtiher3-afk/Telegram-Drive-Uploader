...
| Design | `design/DESIGN_SYSTEM.md`, `M3_OFFICIAL_REVIEW.md`, `OFFICIAL_M3_DESIGN_SYSTEM.md`, `M3_CURRENT_UI_AUDIT.md`, `M3_COMPONENT_MAP.md`, `M3_SCREEN_DESIGN_MATRIX.md`, `M3_SCREEN_DESIGNS.md`, `M3_ADAPTIVE_UI.md`, `M3_EXPRESSIVE_USAGE.md`, `M3_RESEARCH_NOTES.md`, `RTL_DESIGN_GUIDELINES.md`, `MOTION_SYSTEM.md` |
...
| Operations | `operations/README.md`, `MAINTENANCE_INDEX.md`, `FINAL_SELF_CHECK_REPORT.md`, `PRE_PUSH_CHECKLIST.md`, `CHANGE_RISK_MATRIX.md`, `LOGGING_POLICY.md`, `INCIDENT_RESPONSE.md`, `ROLLBACK_PLAN.md`, `HOTFIX_PROCEDURE.md`, `POST_RELEASE_MONITORING.md`, `SUPPORT_GUIDE.md`, `DIAGNOSTIC_GUIDE.md` |
