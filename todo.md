...
- [ ] تدقيق صف الرفع والحالات والتقدم وWorkManager وإصلاح العيوب المثبتة فقط مع اختبارات مركزة.
...
- [ ] إعادة إدخال وتشغيل اختبار DAO مركز عند توفر مصفوفة Robolectric/JDK أو Instrumentation مستقرة؛ محاولة JDK 17 الحالية كانت مقيّدة بالبيئة.
