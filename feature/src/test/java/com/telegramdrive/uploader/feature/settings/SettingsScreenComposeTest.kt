...
class SettingsScreenComposeTest {
    ...
    fun `disabled upload config switches are present`() {
        ...
        composeRule.onNode(hasText(context.getString(com.telegramdrive.uploader.feature.R.string.auto_retry_failed_uploads)))
            .performScrollTo()
            .assertIsDisplayed()
        composeRule.onNode(hasText(context.getString(com.telegramdrive.uploader.feature.R.string.upload_only_wifi)))
            .performScrollTo()
            .assertIsDisplayed()
    }
