    ...
    Scaffold(
        topBar = {
            if (isSelectionMode && uiState is UploadUiState.Success) {
                    ...
                    navigationIcon = {
                        IconButton(
                            ...
                            Icon(
                                ...
                                contentDescription = stringResource(com.telegramdrive.uploader.feature.R.string.clear_selection)
                            )
                        }
                    },
                    actions = {
                        TextButton(
                            ...
                            Text(
                                stringResource(com.telegramdrive.uploader.feature.R.string.select_all),
                ...
                TopAppBar(
                    title = { Text(stringResource(com.telegramdrive.uploader.feature.R.string.prepare_videos)) },
                    navigationIcon = {
                        IconButton(
                            onClick = onBackClick,
                            ...
                            Icon(
                                ...
                                contentDescription = stringResource(com.telegramdrive.uploader.feature.R.string.back)
                            )
                        }
                    }
                )
            ...
            when (val state = uiState) {
                is UploadUiState.Idle -> {
                    EmptyState(
                        ...
                        title = stringResource(com.telegramdrive.uploader.feature.R.string.no_videos_selected),
                        supportingText = stringResource(com.telegramdrive.uploader.feature.R.string.select_videos_from_home),
                        ...
                        Column(
                            ...
                            Card(
                                ...
                                Row(
                                    ...
                                    TextButton(onClick = onSelectDestination) {
                                        Text(stringResource(if (selectedDestination == null) com.telegramdrive.uploader.feature.R.string.select_action else com.telegramdrive.uploader.feature.R.string.schedule_change))
                                    }
                                }
                            }
                            ...
                            Card(
                                ...
                                Row(
                                    ...
                                    Column(modifier = Modifier.weight(1f)) {
                                        Text(stringResource(com.telegramdrive.uploader.feature.R.string.schedule_upload), style = MaterialTheme.typography.titleSmall)
                                        Text(
                                            scheduledAt?.let {
                                    ...
                                    ) { Text(stringResource(if (scheduledAt == null) com.telegramdrive.uploader.feature.R.string.schedule_choose else com.telegramdrive.uploader.feature.R.string.schedule_change)) }
                                    if (scheduledAt != null) {
                                        TextButton(onClick = { viewModel.setScheduledAt(null) }) { Text(stringResource(com.telegramdrive.uploader.feature.R.string.clear)) }
                                    }
                                }
                            }
                            ...
                            Card(
                                ...
                                Row(
                                    ...
                                    FilledTonalButton(
                                        ...
                                        Text(stringResource(com.telegramdrive.uploader.feature.R.string.smart_file_assistant_suggest))
                                    }
                                }
                            }
                            ...
                            Card(
                                ...
                                Column(
                                    ...
                                    Row(
                                        ...
                                        Column(modifier = Modifier.weight(1f)) {
                                            Text(
                                                text = stringResource(com.telegramdrive.uploader.feature.R.string.compression_title),
                                                style = MaterialTheme.typography.titleMedium,
                                                fontWeight = FontWeight.Bold
                                            )
                                            Text(
                                        ...
                                        VideoQualityPreset.values().forEach { preset ->
                                            FilterChip(
                                                ...
                                                label = {
                                                    Text(
                                                        text = when (preset) {
                                                            VideoQualityPreset.LOW -> stringResource(com.telegramdrive.uploader.feature.R.string.compression_low)
                                                            VideoQualityPreset.MEDIUM -> stringResource(com.telegramdrive.uploader.feature.R.string.compression_medium)
                                                            VideoQualityPreset.HIGH -> stringResource(com.telegramdrive.uploader.feature.R.string.compression_high)
                                                            VideoQualityPreset.ORIGINAL -> stringResource(com.telegramdrive.uploader.feature.R.string.compression_original)
                                                        }
                                                    )
                                                },
                            ...
                            Button(
                                ...
                                if (state.isSubmitting) {
                                    ...
                                    Text(
                                        text = stringResource(com.telegramdrive.uploader.feature.R.string.add_to_queue),
