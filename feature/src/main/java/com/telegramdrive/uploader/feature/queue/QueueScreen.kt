                            ...
                            trailingIcon = {
                                if (uiState.query.isNotEmpty()) {
                                    IconButton(onClick = { viewModel.onQueryChanged("") }) {
                                        Icon(
                                            Icons.Default.Clear,
                                            contentDescription = stringResource(com.telegramdrive.uploader.feature.R.string.clear_search)
                                        )
                                    }
                                }
                            },
                            label = { Text(stringResource(com.telegramdrive.uploader.feature.R.string.search_queue_files)) },
                            placeholder = { Text(stringResource(com.telegramdrive.uploader.feature.R.string.filter_active_queue)) }
                        )
                    }
                    item {
