...
internal fun uploadStatusLabelRes(status: UploadStatus): Int = when (status) {
    ...
    UploadStatus.PREPARING -> com.telegramdrive.uploader.feature.R.string.status_preparing
    UploadStatus.UPLOADING -> com.telegramdrive.uploader.feature.R.string.status_uploading
    UploadStatus.PAUSED -> com.telegramdrive.uploader.feature.R.string.status_paused
    UploadStatus.RETRYING -> com.telegramdrive.uploader.feature.R.string.status_retrying
    UploadStatus.COMPLETED -> com.telegramdrive.uploader.feature.R.string.status_completed
    UploadStatus.FAILED -> com.telegramdrive.uploader.feature.R.string.status_failed
    UploadStatus.CANCELLED -> com.telegramdrive.uploader.feature.R.string.status_cancelled
}
        ...
        Column(modifier = Modifier.padding(8.dp)) {
            Row(
                ...
                Crossfade(
                    ...
                    Text(
                        text = stringResource(
                            com.telegramdrive.uploader.feature.R.string.upload_status,
                            visibleStatusLabel
                        ),
                ...
                Row(
                    ...
                    when (video.status) {
                        ...
                        UploadStatus.PAUSED -> {
                            onResumeClick?.let {
                                TextButton(onClick = it) {
                                    Text(stringResource(com.telegramdrive.uploader.feature.R.string.resume))
                                }
                            }
                        }
                        UploadStatus.FAILED -> {
