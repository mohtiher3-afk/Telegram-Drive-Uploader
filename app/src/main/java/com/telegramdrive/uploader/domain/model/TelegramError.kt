...
sealed class TelegramError {
    ...
    fun getLocalizedMessage(): String {
        return when (this) {
            ...
            is TdLibRuntimeUnavailable -> "Telegram integration unavailable in this build. Official TDLib native binaries (libtdjni.so) and Java bindings are not packaged."
            is Unknown -> message
        }
    }
}
