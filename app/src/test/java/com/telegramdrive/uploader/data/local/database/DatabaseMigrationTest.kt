...
/**
 * v5 → v6 must preserve every existing row and expose the new nullable
 * provisionalMessageId column (idempotency bookkeeping). Without this,
 * a retry after SendMessage could resend an already-delivered video.
 *
 * No exported schemas exist in this project, so the v5 database is built by
 * hand with raw SQL, then opened through Room with MIGRATION_5_6 applied.
 */
...
class DatabaseMigrationTest {
    ...
    @Test
    fun migrate5To6_preservesRowsAndAddsNullableColumn() {
